...
INSERT INTO DESARROLLADOR (ID, NOMBRE, FUNDACION, FUNDADOR, EMPLEADOS, SEDE, SITIOWEB, LOGO)
VALUES (nextval('seq_desarrollador'), 'From Software', '1986-11-01', 'Naotoshi Zin', 288, 'Tokio, Japón', 'https://www.fromsoftware.jp/ww/', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Fromsoftware_logo.svg/2560px-Fromsoftware_logo.svg.png');
...
-- 2- Nintendo
INSERT INTO VIDEOJUEGO (ID, NOMBRE, GENERO, ESTRENO, PORTADA, DURACION, TAMANIO, VENTAS, DESARROLLADOR, NOTA)
VALUES (nextval('seq_juegos'), 'The Legend of Zelda: Breath of the Wild', 'Acción-Aventura', '2017-03-03', 'https://m.media-amazon.com/images/I/81U-DS7w+CL.jpg', 50, 13.4, 23000000, 2, 9.5);

INSERT INTO VIDEOJUEGO (ID, NOMBRE, GENERO, ESTRENO, PORTADA, DURACION, TAMANIO, VENTAS, DESARROLLADOR, NOTA)
VALUES (nextval('seq_juegos'), 'Punch-Out!!', 'Deportes', '1984-02-01', 'https://images.wikidexcdn.net/mwuploads/esssbwiki/3/32/latest/20150219163530/Caratula_americana_Punch_Out%21%21.PNG', 5, 0.00003, 2000000, 2, 9.2);

INSERT INTO VIDEOJUEGO (ID, NOMBRE, GENERO, ESTRENO, PORTADA, DURACION, TAMANIO, VENTAS, DESARROLLADOR, NOTA)
VALUES (nextval('seq_juegos'), 'Wario Land 3', 'Plataformas', '2000-03-21', 'https://static.wixstatic.com/media/970a22_2cceeb74b8e7452993a8cf0e06fe8b44~mv2.jpg/v1/fill/w_980,h_984,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/970a22_2cceeb74b8e7452993a8cf0e06fe8b44~mv2.jpg', 10, 3.0 , 2200000, 2, 9.8);

-- 3- Ubisoft
INSERT INTO VIDEOJUEGO (ID, NOMBRE, GENERO, ESTRENO, PORTADA, DURACION, TAMANIO, VENTAS, DESARROLLADOR, NOTA)
VALUES (nextval('seq_juegos'), 'Assassins Creed Valhalla', 'Acción-Aventura', '2020-11-10', 'https://m.media-amazon.com/images/I/81PYKLkWWLL._AC_UF894,1000_QL80_.jpg', 60, 50.2, 13000000, 3, 8.7);
